...
/**
  ...
  * `$ bin/run-example org.apache.spark.examples.streaming.NetworkWithStateWordCount localhost 9999 /Users/will/checkpoint/`
  */
object NetworkWithStateWordCount {
  ...
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setMaster("local[2]").setAppName("NetworkWithStateWordCount")
